...
export const CategoryHeader = ({
  ...
  return (
    <div className="flex flex-wrap justify-between lg:gap-4 items-end pb-4">
      <div>
        <h3 className="text-[32px] font-semibold">Casual</h3>
      </div>
      <div className="flex flex-wrap justify-between gap-4 lg:gap-8 lg:pb-2 items-center">
        <div className="text-[#00000099]">
          <p>Showing 1-10 of 100 Products</p>
        </div>
        {isMobile ? (
          <div
            className="bg-[#F0F0F0] rounded-full p-3"
            onClick={isMobileFiltersActive}
          >
            <svg
              width="22"
              height="19"
